...
public class Pupils {
    ...
    public static void main(String[] args) {
        ...
        Gryffindor harryPotter = new Gryffindor("Гарри Поттер", 92, 15, 35, 9, 47);
        ...
        Slytherin grahamMontague = new Slytherin("Грэхэм Монтегю", 53, 87, 8, 46, 93, 60, 1);
        ...
        Gryffindor.сomPupils(harryPotter,hermioneGranger);
        harryPotter.infoPupils();
    }
}
